...
describe('addItemToArray adds an element to the end of "arr" then returns the array.', function(){
  ...
  const arr = ['coconut', 'peach', 'kiwi']; //fruit
...
//THIS IS NOT A VALID TEST FOR THIS FUNCTION IT SHOULD BE MOVED TO 'addProperty'
  ...
  //   // expect(app.addItemToArray(obj)).to..)
  //   expect(app.addItemToArray(obj,'dollarValue')[obj.length + 1], 'expected new element to be null.').to.be.null; //expect added element to be null. 
